...
import { listAthletes, createAthlete } from '@/lib/modules/athlete/AthleteService';
import { athleteCreateSchema } from '@/lib/utils/validation';
...
export async function POST(request: Request) {
  try {
    ...
    const result = await createAthlete(parsed.data, user.userId);
